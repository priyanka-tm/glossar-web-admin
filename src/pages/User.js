...
import BasicModelUser from 'src/components/commen_Component/User_Add_model';
import axios from 'axios';
import { BASE_URL, getData, getToken } from 'src/utils/comman';
...
export default function User() {
  ...
  const getAllUser = async () => {
    ...
    try {
      const res = await apiInstance.get(`user/get-all`, {
